...
about how ratings are [calculated](https://www.basketball-reference.com/about/ratings.html). Each year refers to the year the season ended. The goal is continuity, tracking how a group of players performed over time regardless of franchise changes. What's fascinating
is how dramatically a team's success and offensive and defensive prowess can change and how teams and divisions compare with one another over time.
